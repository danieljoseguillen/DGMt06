package com.tarea6.dgmt06e02.Controladores;
...
import com.tarea6.dgmt06e02.Domain.sortDTO;
...
public class Controlador {
    ...
    public String postedit(@Valid Empleado empform, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            errmsg = "Hay errores en los campos del formulario.";
    ...
    public String postAdd(@Valid Empleado empform, BindingResult bindingResult, Model model) {
        if (bindingResult.hasErrors()) {
            model.addAttribute("error","Hay errores en los campos del formulario.");
